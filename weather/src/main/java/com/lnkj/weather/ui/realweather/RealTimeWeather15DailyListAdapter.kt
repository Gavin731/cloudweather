...
import com.lnkj.weather.databinding.WeatherItem15dayListBinding
 ...
 * @描述
 */
class RealTimeWeather15DailyListAdapter (data: MutableList<DailyWeather>): BaseQuickAdapter<DailyWeather, BaseViewHolder>(
    R.layout.weather_item_15day_list, data) {

    override fun onItemViewHolderCreated(viewHolder: BaseViewHolder, viewType: Int) {
        DataBindingUtil.bind<WeatherItem15dayListBinding>(viewHolder.itemView)
    }
