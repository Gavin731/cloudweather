...
class ExponentActivity : BaseVMActivity<ExponentViewModel, WeatherActivityExponentInfoBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        // 背景
        if (lifeStyle?.isGood == true) {
            GlideApp.with(this)
                .asDrawable()
                .load(R.drawable.weather_life_index_good_bg)
                .into(object : CustomTarget<Drawable>() {
                    ...
                    override fun onResourceReady(
                        ...
                        binding.llRootView.background = resource;
                    }
                })
        } else {
            GlideApp.with(this)
                .asDrawable()
                .load(R.drawable.weather_life_index_bad_bg)
                .into(object : CustomTarget<Drawable>() {
                    override fun onLoadCleared(placeholder: Drawable?) {
                    }
        ...
        // 表情
        binding.ivFace.imageResource =
            if (lifeStyle?.isGood == true) R.mipmap.weather_icon_smiling_face else R.mipmap.weather_icon_crying_face
