package com.mufeng.sociallibrary.utils
...
object CallbackDataUtil {
  ...
  fun getUserId(data: Map<String, String?>, default: String): String{
    return if (data.containsKey(USER_ID)) data[USER_ID] as String else default
  }
  ...
  fun getCode(data: Map<String, String?>, default: String): String {
    return if (data.containsKey(CODE)) data[CODE] as String else default
  }
