package com.mufeng.sociallibrary.handler.qq
...
import com.mufeng.sociallibrary.callback.ShareCallback
import com.mufeng.sociallibrary.config.OperationType
import com.mufeng.sociallibrary.config.PlatformType
import com.mufeng.sociallibrary.config.SocialConstants
import com.mufeng.sociallibrary.entity.content.*
import com.mufeng.sociallibrary.entity.platform.PlatformConfig
import com.mufeng.sociallibrary.extention.*
import com.mufeng.sociallibrary.handler.SSOHandler
import com.mufeng.sociallibrary.utils.AppUtils
import com.mufeng.sociallibrary.utils.BitmapUtils
import com.mufeng.sociallibrary.utils.FileUtils
...
//    PlatformManager.currentHandlerMap[this.hashCode()] = this
    ...
    val fileDir = when {
      Build.BRAND == "xiaomi" -> // 小米手机
        Environment.getExternalStorageDirectory().path + "/DCIM/Camera/" + "socail_qq_img_tmp"
      Build.BRAND == "Huawei" -> Environment.getExternalStorageDirectory().path + "/DCIM/Camera/" + "socail_qq_img_tmp"
      else -> // Meizu 、Oppo
        Environment.getExternalStorageDirectory().path + "/DCIM/" + "socail_qq_img_tmp"
    }
    val imagePath = fileDir+"socail_qq_img_tmp" + System.currentTimeMillis()+".png"
